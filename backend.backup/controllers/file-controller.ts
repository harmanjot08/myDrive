...
class FileController {
  ...
  uploadFile = async (
    ...
    try {
      ...
      io.to(user._id.toString()).emit("file-uploaded", file);
  ...
  trashFile = async (req: RequestType, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      io.to(userID.toString()).emit("file-deleted", fileID);
  ...
  restoreFile = async (req: RequestType, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      io.to(userID.toString()).emit("file-uploaded", file);
  ...
  deleteFile = async (req: RequestType, res: Response, next: NextFunction) => {
    ...
    try {
      ...
      const fileInfo = await fileService.getFileInfo(userID, fileID);
